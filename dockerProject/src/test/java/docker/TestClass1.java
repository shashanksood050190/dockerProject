...
//		driver = new RemoteWebDriver(new URL("http://192.168.99.100:4446/wd/hub"), dr);
		...
		System.setProperty("webdriver.chrome.driver","C:\\Software\\chromeDriver79\\chromedriver.exe");
	...
	public void closeDriver(ITestResult result) throws MalformedURLException, JiraException {
		if(result.getStatus() == ITestResult.FAILURE)
		{
			...
			Issue issueName=jira.createIssue("AUT", "Bug").field(Field.SUMMARY, result.getMethod().getMethodName()+"is failed due to"+result.getThrowable().toString())
